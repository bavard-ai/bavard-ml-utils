...
from bavard_ml_common.mlops.persistence.record_store.firestore import FirestoreRecordStore
from bavard_ml_common.mlops.persistence.record_store.memory import InMemoryRecordStore
